...
> since advanced to **0.8.2.15**, and `make specdrift` reports **9 of 31 cited sections moved**.
...
## Status: verified against protocol 0.8.2; live spec is 0.8.2.15
...
the pin — but a reader wanting a statement about 0.8.2.15 does not have one yet.
