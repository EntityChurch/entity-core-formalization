...
**Status: certifies protocol 0.8.2; the live spec is 0.8.2.14.** This is the capstone note over
...
> live spec is **0.8.2.14** and `make specdrift` reports **9 of 31 cited sections moved**, so
